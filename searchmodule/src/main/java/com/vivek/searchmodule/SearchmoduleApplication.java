...
import com.vivek.searchmodule.services.GreetingService;
...
public class SearchmoduleApplication {
	...
	public static void main(String[] args) {
		...
		ConfigurableApplicationContext ctx = new AnnotationConfigApplicationContext("com.vivek.searchmodule.services");
